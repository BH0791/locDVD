...
public class ViewDVDFragment extends Fragment {
    ...
    /**
     *  Ma méthode pour travailler
     */
    private void envoieNotification( ) {
        // TODO -> sendNotification modifier
        NotificationCompat.Builder notificationCompat = new NotificationCompat.Builder( getActivity() , "MY_CHANEL");
        notificationCompat.setContentText( dvd.getTitre() );
        notificationCompat.setContentText( dvd.getResume() );
        ...
        if( Build.VERSION.SDK_INT<16) {
            ...
            notification = notificationCompat.getNotification();
    ...
    private void sendNotification( ) {
        ...
        if( Build.VERSION.SDK_INT<16) {
            ...
            NotificationManager notificationManager = (NotificationManager ) getActivity().getSystemService( Context.NOTIFICATION_SERVICE );
            // TODO Bug avec notificationManager
            //notificationManager.notify( (int)dvd.id, notification );
